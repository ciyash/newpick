...
const handleReferralBonus = async (conn, userId) => {
  ...
  // First contest join kaadu — bonus ledu
  ...
  try {
    ...
    /* ─── 6️⃣ REFERRER ki +5 (first time) or +3 (rest) ─── */
